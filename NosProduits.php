            ...
            <div id="produits" class="container">
                <div class="row">
                    ...
                    <div style="text-align:center; padding:1.5cm; position: static;" class="col-xs-12 col-md-6" >
                        <p style=" color:#352f5d; font-family: Arial, Helvetica, sans-serif;">Prix: 7€/1kg</p>
                        ...
                        <div id="stock" class="alert alert-info" style="position: static;">En stock</div>
                    </div>
                </div>
                <hr/>
                ...
                <div class="row">
                    ...
                    <div style="text-align:center; padding:1.5cm; position: static;" class="col-xs-12 col-md-6" >
                        <p style=" color:#352f5d; font-family: Arial, Helvetica, sans-serif;">Prix: 10€/1kg</p>
                ...
                <div class="row">
                    ...
                    <div style="text-align:center; padding:1.5cm; position: static;" class="col-xs-12 col-md-6" >
                        <p style=" color:#352f5d; font-family: Arial, Helvetica, sans-serif;">Prix: 8€/1kg</p>
                ...
                <div class="row">
                    ...
                    <div style="text-align:center; padding:1.5cm; position: static;" class="col-xs-12 col-md-6">
                        <p style=" color:#352f5d; font-family: Arial, Helvetica, sans-serif;">Prix: 6€/1kg</p>
